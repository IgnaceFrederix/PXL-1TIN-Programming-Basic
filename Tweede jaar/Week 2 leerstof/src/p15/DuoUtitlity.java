...
public interface DuoUtitlity {
	public static void printUpper(Duo<String> d){
		System.out.println(d.getFirst().toUpperCase() + "," + d.getSecond().toUpperCase());
	}
	public static void printDuo(Duo<Object>d){
		System.out.println(d.getFirst()+","+d.getSecond());
	}
	//tweede is met wildcard dus dan kan je elk object gebruiken zowel een object als een string
	public static void printDuotwee(Duo<?>d){
		System.out.println(d.getFirst()+","+d.getSecond());
	}
