...
public class MyFrame  extends JFrame {
	...
	private void initListeners(){
		aantal[0].addActionListener(new ActionListener(){

			@Override
			public void actionPerformed(ActionEvent arg0) {
				double hulp = Integer.parseInt(aantal[0].getText())*Double.parseDouble(prijs[0].getText());
				totaal[0].setText(hulp+"");
